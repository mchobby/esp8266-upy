...
# Pin configuration on the PCA9685 (seems identical to MotorShield!)
MOTORWING_PCA_CONFIG = {
	'motors' : {
...
class MotorWing( MotorBase ):
	""" Managing the Motor FeatherWing implementation """
	...
	def __init__( self, i2c, address=0x60, freq=500 ):
		...
		super().__init__( MOTORWING_PCA_CONFIG, i2c, address, freq )
