""" HUSKYLENS : Easy-to-use AI Machine Vision Sensor with MicroPython
  ...
  2) RELOAD the previously save filenum 103 into the HUSKYLENS
...
time.sleep(1)
# Using 103 will reload ObjectTracking_Backup_103.bin from the SDCard.
# Reloading a model may take 6~10 sec.
hl.load_model_from_sd( 103 )
